...
// Firestore refs
const surveyCollectionRef = collection(db, "TrappesTrain");
const counterDocRef = doc(db, "counterTrappesTrain", "surveyCounter");
...
const getNextId = async () => {
  ...
  return `TrappesTrain-${counter.toString().padStart(6, "0")}`;
};
</script>
